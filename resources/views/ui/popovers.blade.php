@extends('layouts.vertical', ['title' => 'Popover'])
...
@include("layouts.shared/page-title", ["subtitle" => "Components", "title" => "Popover"])
            ...
            <div class="flex flex-wrap gap-3">
                <div class="hs-tooltip inline-block [--trigger:click] [--placement:top]">
                    <a class="hs-tooltip-toggle block text-center" href="javascript:;">
                        <div class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-md">
                            Popover on Top
                        </div>
                        <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible transition-opacity opacity-0 relative hidden px-3 py-1 rounded bg-default-800 text-default-200 font-medium w-60 z-50" role="tooltip">
            ...
            <div class="flex flex-wrap gap-3">
                <div class="hs-tooltip inline-block [--trigger:focus] [--placement:bottom-left]">
                    <a class="hs-tooltip-toggle block text-center" href="javascript:;">
                        ...
                        <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible hidden opacity-0 transition-opacity absolute invisible z-70 max-w-xs bg-white border border-default-200 text-start rounded-lg shadow-md" role="tooltip">
                            <span class="pt-3 px-4 block text-lg font-bold text-default-800">Overview</span>
                            <div class="py-3 px-4 text-sm text-default-600">
                                <svg class="rounded-lg mb-3" viewBox="0 0 500 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="500" height="300" class="text-default-300 fill-current" />
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="hs-tooltip [--trigger:hover] sm:[--placement:right] inline-block">
                <div class="hs-tooltip-toggle max-w-xs p-3 flex items-center gap-x-3 bg-white border border-default-200 rounded-xl shadow-sm">
                    <img class="inline-block size-9 rounded-full" src="/images/users/avatar-1.jpg" alt="Image Description">
                    ...
                    <!-- Popover Content -->
                    <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible hidden opacity-0 transition-opacity absolute invisible z-10 max-w-xs w-full bg-white border border-default-100 text-start rounded-xl shadow-md after:absolute after:top-0 after:-start-4 after:w-4 after:h-full" role="tooltip">
                        <!-- Header -->
                        <div class="py-3 px-4 border-b border-default-200">
                            <div class="flex items-center gap-x-3">
                                <img class="flex-shrink-0 inline-block size-10 rounded-full ring-2 ring-white" src="/images/users/avatar-1.jpg" alt="Image Description">
                                <div class="grow">
                                    <h4 class="font-semibold text-default-800">
                                        Amanda Harvey
                                        <span class="ms-0.5 inline-flex items-center align-middle gap-x-1.5 py-0.5 px-1.5 rounded-md text-[11px] font-medium bg-default-800 text-white">
                                            PRO
                                        </span>
                                    </h4>
                        ...
                        <div class="py-2 px-4 flex justify-between items-center bg-default-100">
                            <a class="inline-flex items-center gap-x-1.5 text-xs text-default-500 hover:text-primary disabled:opacity-50 disabled:pointer-events-none" href="#">
